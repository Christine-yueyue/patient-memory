...
Your job: write the clinical note, suggest OHIP billing codes, extract follow-up tasks, generate a patient-friendly summary, surface a few practical insights, and update the patient wiki.
...
OUTPUT FORMAT - return ONLY valid JSON, no markdown, no preamble
{
  ...
  "patient_summary": "Plain-language summary for the patient. Avoid jargon. Explain what changed, what to do next, and any follow-up timing.",
  "insights": [
    "Short AI-generated observations, risk flags, or follow-up suggestions for the clinician"
  ],
  "billing": [
    {
      "code": "A003",
...
- patient_summary must be written for the patient, not the clinician
- insights should be concise, practical observations or suggestions, not a full note
